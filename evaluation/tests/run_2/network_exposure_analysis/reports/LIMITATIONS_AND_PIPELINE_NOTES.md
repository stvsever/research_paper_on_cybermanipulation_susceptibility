...
- H2 has a promising scenario-level descriptive relationship: `peer_private_attack_activation` versus `pn_increment_effectivity` has Pearson `r = 0.420`.

## BN Delta Expansion Note

Stage `02b` canonical profile-opinion assessments report:

- mean `BN - B`: `-28.72222222222222`
- mean absolute `BN - B`: `49.422222222222224`

Stage `05` expanded scenario rows report:

- mean `network_exposure_delta_score`: `-28.705555555555556`
- mean absolute `network_exposure_delta_score`: `175.45277777777778`
