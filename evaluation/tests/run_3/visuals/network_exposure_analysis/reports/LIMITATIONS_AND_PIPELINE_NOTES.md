...
- H2 has a promising scenario-level descriptive relationship: `peer_private_attack_activation` versus `pn_increment_effectivity` has Pearson `r = -0.123`.

## BN Delta Expansion Note

Stage `02b` canonical profile-opinion assessments report:

- mean `BN - B`: `2.065260382333553`
- mean absolute `BN - B`: `15.9887936717205`
