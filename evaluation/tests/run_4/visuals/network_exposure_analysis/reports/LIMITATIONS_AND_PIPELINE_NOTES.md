...
- H2 (network propagation) is confirmed at the receiver level: the direction-aware peer-position pull `peer_pull_toward_goal` versus `pn_increment_effectivity` has Pearson `r = 0.342`.
...
- mean `BN - B`: `0.17`
- mean absolute `BN - B`: `43.416046511627904`
