"""
Ontology validator for utils-provided PROFILE × ATTACK × OPINION JSON files.
...
def validate_ontology_triplet(
    ...
    """Validate a utils-provided ontology triplet (PROFILE, ATTACK, OPINION).
...
def load_user_ontology_triplet(
    ...
    """Load and optionally validate a utils-provided ontology triplet.
