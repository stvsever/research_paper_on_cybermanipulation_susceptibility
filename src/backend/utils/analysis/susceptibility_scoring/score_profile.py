...
Usage
-----
python src/backend/pipeline/01_separated/compute_conditional_susceptibility/score_profile.py \\
...
from src.backend.utils.embeddings.semantic_scale import get_default_registry as _get_scale_registry
...
def _parse_profile_to_feature_row(
    ...
    """
    Map a utils-facing profile dict → model feature column format.
    ...
    # ── Process each key in the utils-supplied profile dict ───────────────────
