...
def run_all(run_dir: Path, visuals_root: Path) -> None:
    ...
    # Fallback: search
    for cand in [run_dir.parents[2] / "src/backend/ontology/01_separated/test/OPINION/opinion.json",
                 run_dir.parents[2] / "src/backend/ontology/01_separated/production/OPINION/opinion.json"]:
