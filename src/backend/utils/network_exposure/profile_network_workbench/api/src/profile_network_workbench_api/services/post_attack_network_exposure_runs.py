...
def _peer_context(
    *,
    ...
    from src.backend.utils.scenario.profile_affinity import compute_profile_affinities, rank_profile_neighbors
...
def _run_post_attack_network_batch(
    ...
    def process(item: dict[str, Any]) -> PostAttackNetworkExposureResult:
        ...
        from src.backend.utils.scenario.scenario_realism import assess_post_attack_network_exposure_heuristics
