...
from src.backend.utils.figures.generate_main_readme_figures import generate_main_readme_figures
from src.backend.utils.io import abs_path, ensure_dir, write_json, write_text
from src.backend.utils.scenario.scenario_realism import pretty_label
