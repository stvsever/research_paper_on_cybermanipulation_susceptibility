...
in src/backend/ontology/01_separated/test/OPINION/opinion.json _metadata.

Run as a script:
    python3 -m src.backend.utils.scenario.inject_opinion_directions \
        --in  src/backend/ontology/01_separated/production/OPINION/opinion.json \
        --out src/backend/ontology/01_separated/production/OPINION/opinion.json \
        --in-place
"""
